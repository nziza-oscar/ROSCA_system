...
import { Bell, Menu, ChevronDown, User, Settings , LogOut, Mail, MessageSquare, AlertCircle  } from "lucide-react"
          ...
          {userDropdownOpen && (
            <div className="absolute  right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-40">
              ...
              <div className="border-t border-gray-200 py-2">
                <button
                  className="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors w-full cursor-pointer"
                  onClick={logout}
                >
