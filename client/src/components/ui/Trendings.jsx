...
export default function Trendings({ products }) {
  return (
        ...
        <Swiper 
          ...
          {products.map((product, index) => (
            <SwiperSlide key={index}>
              <Link to="/details/products" className="product-card min-w-[250px] shadow">
                ...
                <p className="text-gray-500 mb-2">Price {product.price} RWF</p>
              </Link>
            </SwiperSlide>
          ))}
        </Swiper>
